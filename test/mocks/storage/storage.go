...
// StatTag provides a mock function with given fields: ctx, repo, tag
func (_m *Storage) StatTag(ctx context.Context, repo string, tag string) (bool, error) {
	ret := _m.Called(ctx, repo, tag)

	if len(ret) == 0 {
		panic("no return value specified for StatTag")
	}
...
// Storage_StatTag_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StatTag'
type Storage_StatTag_Call struct {
	*mock.Call
}

// StatTag is a helper method to define mock.On call
//   - ctx context.Context
//   - repo string
//   - tag string
func (_e *Storage_Expecter) StatTag(ctx interface{}, repo interface{}, tag interface{}) *Storage_StatTag_Call {
	return &Storage_StatTag_Call{Call: _e.mock.On("StatTag", ctx, repo, tag)}
}

func (_c *Storage_StatTag_Call) Run(run func(ctx context.Context, repo string, tag string)) *Storage_StatTag_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *Storage_StatTag_Call) Return(_a0 bool, _a1 error) *Storage_StatTag_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Storage_StatTag_Call) RunAndReturn(run func(context.Context, string, string) (bool, error)) *Storage_StatTag_Call {
	_c.Call.Return(run)
	return _c
}
