...
func (_e *Builder_Expecter) BuildConfig(ctx interface{}) *Builder_BuildConfig_Call {
	return &Builder_BuildConfig_Call{Call: _e.mock.On("BuildConfig", ctx)}
}
...
func (_m *Builder) BuildLayer(ctx context.Context, mediaType string, workDir string, path string) (v1.Descriptor, error) {
	ret := _m.Called(ctx, mediaType, workDir, path)
	...
	var r0 v1.Descriptor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) (v1.Descriptor, error)); ok {
		return rf(ctx, mediaType, workDir, path)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) v1.Descriptor); ok {
		r0 = rf(ctx, mediaType, workDir, path)
	} else {
		r0 = ret.Get(0).(v1.Descriptor)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, string) error); ok {
		r1 = rf(ctx, mediaType, workDir, path)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *Builder_Expecter) BuildLayer(ctx interface{}, mediaType interface{}, workDir interface{}, path interface{}) *Builder_BuildLayer_Call {
	return &Builder_BuildLayer_Call{Call: _e.mock.On("BuildLayer", ctx, mediaType, workDir, path)}
}
...
func (_m *Builder) BuildManifest(ctx context.Context, layers []v1.Descriptor, config v1.Descriptor, annotations map[string]string) (v1.Descriptor, error) {
	ret := _m.Called(ctx, layers, config, annotations)
	...
	var r0 v1.Descriptor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []v1.Descriptor, v1.Descriptor, map[string]string) (v1.Descriptor, error)); ok {
		return rf(ctx, layers, config, annotations)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []v1.Descriptor, v1.Descriptor, map[string]string) v1.Descriptor); ok {
		r0 = rf(ctx, layers, config, annotations)
	} else {
		r0 = ret.Get(0).(v1.Descriptor)
	}

	if rf, ok := ret.Get(1).(func(context.Context, []v1.Descriptor, v1.Descriptor, map[string]string) error); ok {
		r1 = rf(ctx, layers, config, annotations)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *Builder_Expecter) BuildManifest(ctx interface{}, layers interface{}, config interface{}, annotations interface{}) *Builder_BuildManifest_Call {
	return &Builder_BuildManifest_Call{Call: _e.mock.On("BuildManifest", ctx, layers, config, annotations)}
}
...
func (_c *Builder_BuildManifest_Call) Run(run func(ctx context.Context, layers []v1.Descriptor, config v1.Descriptor, annotations map[string]string)) *Builder_BuildManifest_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]v1.Descriptor), args[2].(v1.Descriptor), args[3].(map[string]string))
	})
	return _c
}
