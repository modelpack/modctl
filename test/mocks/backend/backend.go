...
// Extract provides a mock function with given fields: ctx, target, output
func (_m *Backend) Extract(ctx context.Context, target string, output string) error {
	ret := _m.Called(ctx, target, output)
...
//   - target string
//   - output string
func (_e *Backend_Expecter) Extract(ctx interface{}, target interface{}, output interface{}) *Backend_Extract_Call {
	return &Backend_Extract_Call{Call: _e.mock.On("Extract", ctx, target, output)}
}

func (_c *Backend_Extract_Call) Run(run func(ctx context.Context, target string, output string)) *Backend_Extract_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Backend_Extract_Call) RunAndReturn(run func(context.Context, string, string) error) *Backend_Extract_Call {
	_c.Call.Return(run)
	return _c
}
